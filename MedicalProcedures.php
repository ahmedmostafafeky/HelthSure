<?php 
    ...
    ///////////////////////////////////////////////////
    $sql1 = "SELECT * FROM procedures WHERE id = '$id'";
...
<body>
                ...
                <div class="col-sm-12">
                    <div class="header_2">
                        <h5><a href="home.php">HOME</a>
                            ...
                            <span class="well_1"><i class="fa fa-caret-right"></i></span> <a href="MedicalProcedures.php"> Medical Procedures</a>
                            <h5>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="title">
                        <h2>MEDICA<span class="title_border">L PROC</span>EDURES</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="medical-procedures">
        ...
        <hr>
        <hr>
        <div class="medical-procedures-bottom">
            <h3>Add Procedures</h3>
            <form action="backend/proced.php" method="post">
