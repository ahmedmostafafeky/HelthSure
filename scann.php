...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a class="active_tag" href="scann.php">QR-Code</a></li>
                    </ul>
                    <div class="profile">
                ...
                <div class="col-sm-12">
                    <div class="header_2">
                        <h5><a href="home.php">HOME</a>
                            <span class="well_1"><i class="fa fa-caret-right"></i></span> <a href="scann.php"> Scaan Qr</a>
                            <h5>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="title">
                        <h2>SC<span class="title_border">AA</span>N</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="scaan-main">
        
        <div class= "scaan-main-inner">
        <form action="backend/viowin.php" method="post">
            <label class="plabel" for="id">Input ID: </label>
            <input class="edit-input" id = "id" name='id' placeholder='Input ID' type='text'>
            <input class="edit-submit" class='animated' type='submit' value='Scann'>
        </form>
        </div>
    </section>
