<?php 
    ...
    ///////////////////////////////////////////////////
    $sql1 = "SELECT * FROM surgerys WHERE id = '$id'";
    $result1 = mysqli_query($con, $sql1);  
    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC); 
    ///////////////////////////////////////////////////

    $sql2 = "SELECT * FROM illneses WHERE id = '$id'";
...
<body>
                ...
                <div class="col-sm-12">
                    <div class="header_2">
                        <h5><a href="home.php">HOME</a>
                            ...
                            <span class="well_1"><i class="fa fa-caret-right"></i></span> <a href="MedicalHistory.php"> Medical History</a>
                            <h5>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="title">
                        <h2>MEDIC<span class="title_border">AL HI</span>STORY</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="helth-history-main">
        <div class="helth-history-main-top">
            <div>
                ...
                <table>
                    ...
                    echo "<td>" . $row1['description'] . "</td></tr>";
        ...
        <hr>
        <hr>
        <div class="helth-history-main-bottom">
            <div>
                <h3>Add Surgary</h3>
                <form action = "backend/suragrys.php" method = "post">
                    <label class="plabel" for ="name">Surary Name: </label>
                    ...
                    <label class="plabel" for ="Sdesc">Description: </label>
                    <input name ="desc" class="edit-input" id="Sdesc" type="text">
            ...
            <div>
                <h3>Add Ilness</h3>
                <form action = "backend/illneses.php" method = "post">
                    <label class="plabel" for ="name">illnes Name: </label>
                    <input name ="name" class="edit-input" id="name" type="text">
                    <label class="plabel" for ="date">Date: </label>
                    <input name ="date" class="edit-input" id="date" type="text">
                    <label class="plabel" for ="idesc">Description: </label>
                    <input name ="desc" class="edit-input" id="idesc" type="text">
                    <input class="edit-submit" type="submit" value = "Add">
                </form>
            </div>
        </div>
